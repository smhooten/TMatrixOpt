...
if __name__ == '__main__':
    ...
    for Np in Nps:
        ...
        layer2 = geometry.LinearChirp('linearchirp', 0.19, 0.8, Np, SiO2, a_Si, 1.4, 3.05, True)
        ...
        if RANK == 0:
            ...
            scipy.io.savemat('results_Np'+str(Np)+'_variablesuperstrate_dispersiveSi_fixedSio2.mat', to_save)
            stack.print_info()
            #stack.plot_fom()
