...
if __name__ == '__main__':
    ...
    for Np in Nps:
        ...
        opt = optimizer.Optimizer(stack, params, callback_func=callback, opt_method=opt_method, Nmax=1000, tol=1e-10, bounds=bounds, scipy_verbose=True, additional_options=additional_options)
        ...
        if RANK == 0:
            ...
            scipy.io.savemat('results_Np'+str(Np)+'.mat', to_save)
            stack.print_info()
            #stack.plot_fom()
